  ...
  return {
    ...
    link:function (originalScope, element, attrs, modelCtrl) {
      ...
      modelCtrl.$parsers.unshift(function (inputValue) {
        ...
        if (isEditable) {
          ...
          if (!inputValue) {
            ...
            //modelCtrl.$setValidity('optionValidator', !isRequired);
            modelCtrl.$setValidity('required', !isRequired);
            modelCtrl.$setValidity('optionValidator', !isRequired);
            return inputValue;
          } else {
      ...
      element.bind('click', function (evt) {
          if (modelCtrl.$viewValue === "" || !modelCtrl.$viewValue) {
              modelCtrl.$setViewValue(" ");
          }
      });
...
angular.module("template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/accordion/accordion-group.html",
    ...
    "      <a href=\"javascript:void(0)\" tabindex=\"0\" class=\"accordion-toggle\"  accordion-transclude=\"heading\"><span ng-class=\"{'text-muted': isDisabled}\">{{heading}}</span></a>\n" +
    "    </h4>\n" +
    "  </div>\n" +
