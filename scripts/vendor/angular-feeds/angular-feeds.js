...
angular.module('feeds').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('feed-list.html',
    ...
    "    </div>\n" +
    "\n" +
    "    <ul class=\"media-list\" style=\"padding-top: 10px;padding-left: 20px;\">\n" +
    "        <li ng-repeat=\"feed in feeds | orderBy:publishedDate:reverse\" class=\"media\">\n" +
    "            <div class=\"media-body\">\n" +
    "                <p class=\"media-heading\" style=\"font-size: 9pt;\"><a target=\"_new\" href=\"{{feed.link}}\" style=\"color:normal;\" ng-bind-html=\"feed.title\"></a></p>\n" +
    "                <p ng-bind-html=\"!summary ? feed.content : feed.contentSnippet\"></p>\n" +
    "            </div>\n" +
    "            <div ng-if=\"!$last\" style=\"border-bottom:1px solid #cccccc;\"></div>\n" +
    "        </li>\n" +
    "    </ul>\n" +
    "</div>"
  );
